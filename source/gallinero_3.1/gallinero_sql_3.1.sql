...
CREATE TABLE IF NOT EXISTS `granja_tpCuatrimestral`.`Planilla` (
  ...
  `novedades` TEXT NULL,
  `Legajo_Usuario` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `granja_tpCuatrimestral`.`Clientes` (
  ...
  INDEX `fk_Clientes_Localidad1_idx` (`Localidad_idLocalidad` ASC),
  INDEX `fk_Clientes_Provincia1_idx` (`Provincia_idProv` ASC),
